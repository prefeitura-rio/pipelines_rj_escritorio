...
def redis_add_to_prediction_buffer(
    key: str, value: bool, redis_client: RedisPal, len_: int = 3
) -> List[bool]:
    """
...
def redis_get_prediction_buffer(key: str, redis_client: RedisPal, len_: int = 3) -> List[bool]:
    """
